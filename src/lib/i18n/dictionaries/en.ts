...
export const en = {
  ...
  drafts: {
    ...
    emptyDesc: "Records you start but don't submit are saved here so you can finish them later.",
  },
  mileage: {
    title: "Mileage",
    subtitle: "Log the miles you drive for work.",
    back: "Records",
    ...
    miShort: "mi",
    note: "Note",
    notePlaceholder: "Where to, or which job?",
    save: "Save",
    saving: "Saving…",
    delete: "Delete",
  ...
  onboarding: {
    ...
    platformConsole: "Platform console",
    platformConsoleSub: "Manage every company on the platform.",
  },
  records: {
    ...
    // Downloadable pay statement (PDF)
    downloadStatement: "Download statement (PDF)",
    periodThisMonth: "This month",
    periodLastMonth: "Last month",
    periodThisYear: "This year",
    stmtTitle: "Pay statement",
    stmtFor: "For {name}",
    stmtApprovedNote: "Approved records only.",
    stmtColDate: "Date",
    stmtColJob: "Job #",
    stmtColCustomer: "Customer",
    stmtColHours: "Hours",
    stmtColPay: "Pay",
    stmtTotal: "Total",
    stmtEmpty: "No approved records in this period.",
  ...
  expenses: {
    title: "Expenses",
    subtitle: "Costs booked against your jobs.",
    newExpense: "New expense",
    searchPlaceholder: "Search vendor or note…",
    ...
    emptyDesc: "Log a cost — fuel, permits, a subcontractor — to start tracking job profitability.",
    ...
    deleteDesc: "This removes the expense permanently.",
    deleteConfirm: "Delete expense",
    // Categories
    manageCategories: "Categories",
    categoriesTitle: "Expense categories",
    categoriesDesc: "Group expenses so you can filter and report on them.",
    newCategory: "New category",
    categoryNamePlaceholder: "e.g. Fuel",
    addCategory: "Add",
  ...
  materials: {
    title: "Materials",
    subtitle: "Your catalog of materials and unit costs.",
    newMaterial: "New material",
    searchPlaceholder: "Search materials…",
    searchAria: "Search materials",
    catalog: "In catalog",
    countOne: "{n} material",
    countMany: "{n} materials",
    emptyTitle: "No materials yet",
    emptyDesc: "Add a material with its unit cost to attach it to jobs and track material spend.",
    noMatches: "No materials match",
    noMatchesDesc: "Try a different search.",
    // Form
    name: "Name",
    namePlaceholder: 'e.g. 3/4" PVC pipe',
    unit: "Unit",
    unitPlaceholder: "e.g. ft, box, each",
    ...
    deleteDesc: "This removes it from the catalog. Lines already on jobs are kept.",
    deleteConfirm: "Delete material",
    // Per-record materials section
    ...
    noneOnRecord: "No materials on this job yet.",
    remove: "Remove",
    add: "Add",
  },
  budgets: {
    title: "Budgets",
    subtitle: "Set a monthly spend cap per expense category and watch it.",
    spentLabel: "Spent this month",
    budgetLabel: "Total budget",
    alertOver: "{n} over budget",
    alertNear: "{n} nearing budget",
    allWithin: "Every category is within budget this month.",
    emptyTitle: "No categories yet",
    emptyDesc: "Add expense categories first, then set a monthly budget for each.",
    setBudget: "Set budget",
    edit: "Edit",
    budgetPlaceholder: "Monthly cap",
  ...
  profitability: {
    ...
    editRevenue: "Edit",
    jobValue: "Job value",
    jobValuePlaceholder: "What the job billed",
    noRevenueHint: "Set the job's revenue to see its margin.",
  },
  collections: {
    title: "Collections",
    subtitle: "Overdue and soon-due invoices, ready to chase.",
    overdueLabel: "Overdue ({n})",
    dueSoonLabel: "Due soon ({n})",
    bucket61: "Over 60 days late",
    bucket3160: "31–60 days late",
    bucket130: "1–30 days late",
    bucketDueSoon: "Due this week",
    daysLate: "{n}d late",
    dueToday: "Due today",
    ...
    sending: "Sending…",
    view: "View",
    reminderSent: "Reminder emailed.",
    reminderNoEmail: "No email on file for this customer.",
    reminderNotConfigured: "Email isn't set up yet.",
    reminderFailed: "Couldn't send the reminder.",
    emptyTitle: "Nothing to collect",
    emptyDesc: "No overdue or soon-due invoices. Nicely done.",
  },
  digest: {
    heading: "In plain terms",
    revenueUp: "You brought in {revenue}, up {deltaPct}% from the previous period.",
    revenueDown: "You brought in {revenue}, down {deltaPct}% from the previous period.",
    revenueFlat: "You brought in {revenue}, about level with the previous period.",
    revenueOnly: "You brought in {revenue} this period.",
    profitPositive: "After {labor} in labor, gross profit was {grossProfit} — a {margin}% margin.",
    profitNegative: "Labor of {labor} outran revenue, leaving a {grossProfit} gross loss.",
    owedWithOverdue: "Customers owe you {outstanding}, including {overdue} overdue across {overdueCount} invoices.",
    owedClean: "Customers owe you {outstanding}, none of it overdue.",
    jobs: "You completed {jobs} jobs.",
    topCustomer: "{name} was your top customer at {total}.",
  ...
  reportShare: {
    ...
    desc: "Create a private link to a read-only snapshot of your finances — no account needed to view it.",
    createLink: "Create link",
    creating: "Creating…",
    linkLabel: "Shareable link",
    copy: "Copy",
    copied: "Copied",
    liveNote: "The report stays live and always shows your latest numbers.",
    stopSharing: "Stop sharing",
    // Public page
    ...
    outstanding: "Outstanding",
    jobs: "Jobs",
    footer: "Read-only snapshot. Figures update automatically.",
  },
  sankey: {
  ...
  schedule: {
    ...
    todayView: "View",
    todayMore: "+{n} more",
    todayOpenSchedule: "Open schedule",
