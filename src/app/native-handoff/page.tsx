...
// an eivsolutionair:// deep link. The app reads the token from the link and
// writes it into its own WebView's cookie jar (see NativeAuthBridge).
export default async function NativeHandoffPage() {
  ...
  const deepLink = `eivsolutionair://auth-callback?${params.toString()}`;
